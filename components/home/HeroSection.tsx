...
/>
        ...
        <div className="text-center md:text-left md:order-1">
          ...
          <p className="mt-3 text-sm md:text-lg text-neutral-300 max-w-xl">
          ...
          <div className="mt-4 flex flex-row gap-2 justify-center md:justify-start">
            ...
            <Link
              href="#movies"
              className="flex-1 md:flex-none rounded-xl bg-gradient-to-r from-[#facc15] to-[#f59e0b] px-5 py-2.5 text-sm font-black uppercase tracking-wider text-black flex items-center justify-center gap-2 hover:scale-[1.02] transition-all duration-300 shadow-[0_0_25px_rgba(251,191,36,0.35)]"
            >
              Enter The Arena
            ...
            <Link
              href="/leaderboard"
              className="flex-1 md:flex-none rounded-xl border border-[#fbbf24]/40 bg-[#1a0f0d] px-5 py-2.5 text-sm font-black uppercase tracking-wider text-[#fbbf24] flex items-center justify-center hover:bg-[#fbbf24] hover:text-black transition-all duration-300"
            >
              View Leaderboard
            </Link>
